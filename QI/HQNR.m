...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [HQNR_value,Dl,Ds] = HQNR(ps_ms,ms,msexp,pan,S,sensorInf,ratio)


Dl = D_lambda_K(ps_ms,msexp,ratio,sensorInf,S);
Ds = D_s(ps_ms,msexp,ms,pan,sensorInf,ratio,S,1);
%Ds = D_s(ps_ms,msexp,ms,pan,ratio,sensorInf,S,1);
